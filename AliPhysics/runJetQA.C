/// \Original file runEMCalJetSampleTask.C
...
)
{
  ...
  // Sample task - here I should then add the (not yet written) AddTaskEmcalJet.C to produce qa from jets out of the jetfinder
