void runAnalysis()
{
    ...
    // compile the class (locally) - 1 enter aliphysics, then root, then load these manually.. as quick fix --> see runLocalAOD.sh: enter AliPhysics, then bash run :)
    ...
    if(local) {
        ...
        chain->Add("/home/johannalomker/alice/serviceTask/PWGJE/data/AliAOD.root");
